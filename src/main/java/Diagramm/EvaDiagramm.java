...
public class EvaDiagramm extends JFrame
{
    ...
    public EvaDiagramm(final String title, ObjectOutputStream coos, ObjectInputStream cois)
    {
        super(title);
        this.cois=cois;
        this.coos=coos;
        CategoryDataset dataset    = Dataset.createDatasetEVAOfCompany(coos,cois);
    ...
    private JFreeChart createChart(final CategoryDataset dataset)
    {
        final JFreeChart chart = ChartFactory.createBarChart(
                "Градация эффективностей компаний",   // chart title
                "Имя компании",                  // domain axis label
                "Экономическая добавленная стоимость",                  // range axis label
                dataset,                  // data
