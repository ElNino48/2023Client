...
public class CompanyCreateDateDiagramm extends JFrame
{
    ...
    public CompanyCreateDateDiagramm(final String title, ObjectOutputStream coos, ObjectInputStream cois)
    {
        super(title);
        this.cois=cois;
        this.coos=coos;
        CategoryDataset dataset    = Dataset.createDatasetAgeOfCompany(coos,cois);
    ...
    private JFreeChart createChart(final CategoryDataset dataset)
    {
        final JFreeChart chart = ChartFactory.createBarChart(
                "Возраст компаний",   // chart title
                "Имя компании",                  // domain axis label
                "Количество лет",                  // range axis label
                dataset,                  // data
